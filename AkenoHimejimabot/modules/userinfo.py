...
from AkenoHimejimabot import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from AkenoHimejimabot.__main__ import STATS, TOKEN, USER_INFO
import AkenoHimejimabot.modules.sql.userinfo_sql as sql
from AkenoHimejimabot.modules.disable import DisableAbleCommandHandler
from AkenoHimejimabot.modules.sql.global_bans_sql import is_user_gbanned
from AkenoHimejimabot.modules.sql.afk_sql import is_afk, check_afk_status
from AkenoHimejimabot.modules.sql.users_sql import get_user_num_chats
from AkenoHimejimabot.modules.sql.feds_sql import get_user_fbanlist
from AkenoHimejimabot.modules.helper_funcs.chat_status import sudo_plus
from AkenoHimejimabot.modules.helper_funcs.extraction import extract_user
from AkenoHimejimabot import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text(
                "President Rias wants your location.")
            return
